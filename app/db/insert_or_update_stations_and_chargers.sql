...
BEGIN
    ...
    LOOP
        ...
        INSERT INTO public.stations (
            station_name, external_station_id, address, detail_location, lat, lng,
            org_id, org_name, org_contact, z_code, parking_free, note, available,
            available_detail, is_deleted, is_deleted_detail, zs_code, usable_time, slug
        )
        VALUES (
        ...
        ON CONFLICT (station_name, external_station_id)
        DO UPDATE SET
            address = EXCLUDED.address, detail_location = EXCLUDED.detail_location, 
            lat = EXCLUDED.lat, lng = EXCLUDED.lng, org_id = EXCLUDED.org_id, 
            org_name = EXCLUDED.org_name, org_contact = EXCLUDED.org_contact, 
            ...
            zs_code = EXCLUDED.zs_code, usable_time = EXCLUDED.usable_time, slug = EXCLUDED.slug
